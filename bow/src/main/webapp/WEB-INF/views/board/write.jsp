...
<script>
	...
	$(document).ready(function(){
		...
		//파일추가
		function fn_addFile(){
			var str = "<p><input type='file' name='files'><a href='#this' class='btn' name='delete'>삭제</a></p>"
			$('#fileDiv').append(str);
...
<div class="container">
	...
	<form method="post" id="frm" name="writeForm" enctype="multipart/form-data">
